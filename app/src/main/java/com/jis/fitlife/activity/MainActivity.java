...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSeries = getSharedPreferences("PREFERENCE", MODE_PRIVATE)
                .getFloat("stepgoal", 0f);
        mSeries1 = getSharedPreferences("PREFERENCE", MODE_PRIVATE)
                .getFloat("caloriegoal", 0f);

        String name =  getSharedPreferences("PREFERENCE", MODE_PRIVATE)
                .getString("USER_NAME", "abc");
        String email = getSharedPreferences("PREFERENCE", MODE_PRIVATE)
                .getString("USER_EMAIL", "abc@gmail.com");
        ...
        mSeriesMax = mSeries;
        Log.d("SetGoal mseries", String.valueOf(mSeries));
        if (mSeriesMax == 0) {
            mSeriesMax = mSeries1;
        }
        final String cap1;
